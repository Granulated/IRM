...
/*
Function BlobDetect detects blobs in the source image
Inputs:
IplImage* inImg - source image  
int thresh - Canny edge detection algorithm threshold 
Outputs:
/
Return:
0
...
/*
Function DoGTracking calculates the center position of the given red ball based on a difference of gaussians.
*/
